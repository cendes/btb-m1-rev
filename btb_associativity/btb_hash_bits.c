...
int main() {
  ...
  uint8_t* map_addr = mmap((uint8_t*) (BRANCH_ADDR + code_offset), BRANCH_LEN,
  ...
  memcpy((uint8_t*) (BRANCH_ADDR + code_offset), (uint8_t*) map_b_instrs_addr, BRANCH_LEN);
